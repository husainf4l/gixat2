...
[SuppressMessage("Design", "CA1515:Consider making public types internal", Justification = "Required to be public for HotChocolate type discovery")]
public sealed record RegisterInput(string Email, string Password, string FullName, string Role, UserType UserType, Guid OrganizationId, string? InviteCode = null);
