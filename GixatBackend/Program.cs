...
#pragma warning disable CA2263 // Prefer generic overload - Static types cannot be used as type arguments
        ...
        .AddTypeExtension(typeof(GixatBackend.Modules.JobCards.GraphQL.InventoryQueries))
        .AddTypeExtension(typeof(GixatBackend.Modules.JobCards.GraphQL.LaborQueries))
    ...
    .AddMutationType()
        ...
        .AddTypeExtension(typeof(GixatBackend.Modules.JobCards.GraphQL.InventoryMutations))
        .AddTypeExtension(typeof(GixatBackend.Modules.JobCards.GraphQL.JobItemPartsAndLaborMutations))
    ...
    .AddType(typeof(GixatBackend.Modules.JobCards.GraphQL.JobCardCommentExtensions))
    .AddType(typeof(GixatBackend.Modules.JobCards.GraphQL.JobCardCommentMentionExtensions))
