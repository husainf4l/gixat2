...
namespace GixatBackend.Migrations
{
    ...
    partial class AddPartsInventoryAndLaborTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GixatBackend.Modules.Appointments.Models.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssignedTechnicianId", "ScheduledStartTime")
                        .HasFilter("\"AssignedTechnicianId\" IS NOT NULL");

                    b.HasIndex("CustomerId", "ScheduledStartTime");

                    b.HasIndex("OrganizationId", "ScheduledStartTime", "Status");
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "IsActive", "QuantityInStock");
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.JobCardComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JobItemId", "CreatedAt")
                        .HasFilter("\"JobItemId\" IS NOT NULL");

                    b.ToTable("JobCardComments");
                });

            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.JobCardCommentMention", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("JobCardCommentMentions");
                });
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.JobItemPart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JobItemId", "IsActual");

                    b.ToTable("JobItemParts");
                });

            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.LaborEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GixatBackend.Modules.Appointments.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("GixatBackend.Modules.Users.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("GixatBackend.Modules.Sessions.Models.GarageSession", "Session")
                        .WithOne()
                        .HasForeignKey("GixatBackend.Modules.Appointments.Models.Appointment", "SessionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.JobCardComment", b =>
                {
                    b.HasOne("GixatBackend.Modules.Users.Models.ApplicationUser", "Author")
                        .WithMany()
                    ...
                    b.HasOne("GixatBackend.Modules.JobCards.Models.JobCardComment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.JobCardCommentMention", b =>
                {
                    b.HasOne("GixatBackend.Modules.JobCards.Models.JobCardComment", "Comment")
                        .WithMany("Mentions")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GixatBackend.Modules.Users.Models.ApplicationUser", "MentionedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.JobItemPart", b =>
                {
                    b.HasOne("GixatBackend.Modules.JobCards.Models.InventoryItem", "InventoryItem")
            ...
            modelBuilder.Entity("GixatBackend.Modules.JobCards.Models.LaborEntry", b =>
                {
                    ...
                    b.HasOne("GixatBackend.Modules.Users.Models.ApplicationUser", "Technician")
                        .WithMany()
